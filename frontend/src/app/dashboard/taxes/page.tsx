  ...
  return (
    <main className="af-db-main">
      <div className="af-db-topbar">
        ...
        <button className="af-btn-primary" style={{ cursor: 'pointer', border: 'none' }} onClick={() => router.push('/dashboard/taxes/new')}>
          + Add New
        </button>
      </div>
                ...
                <tr key={tx.id}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => router.push(`/dashboard/taxes/edit?id=${tx.id}`)}
                    >
                      Edit
                    </button>
                  </td>
