  ...
  return (
    <main className="af-db-main">
      <div className="af-db-topbar">
        ...
        <button className="af-btn-primary" onClick={() => router.push('/dashboard/vendors/new')} style={{ cursor: 'pointer', border: 'none' }}>+ New Vendor</button>
      </div>
                ...
                <tr key={v.id}>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: 8 }}>
                      <button className="af-prop-act edit" title="Edit" onClick={() => router.push(`/dashboard/vendors/edit?id=${v.id}`)}>✏️</button>
